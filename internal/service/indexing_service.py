...
from internal.task.rag_task import process_single_document_task
...
class IndexingService(BaseService):
    ...
    def build_documents(self, document_ids: list[UUID]) -> None:
        ...
        for document in documents:
            try:
                ...
                process_single_document_task.delay(str(document.id))
    ...
    def parsing(self, document: Document) -> list[LCDocument]:
    ...
    def splitting(self, document: Document, lc_documents: list[LCDocument]) -> list[LCDocument]:
    ...
    def indexing(self, document: Document, lc_segments: list[LCDocument]) -> None:
    ...
    def completed(self, document: Document, lc_segments: list[LCDocument]) -> None:
