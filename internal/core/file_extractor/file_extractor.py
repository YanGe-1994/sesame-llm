...
class FileExtractor:
    ...
    def load(
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # 3.将对象存储中的文件下载到本地
            self.OssService.download_file(upload_file.key, file_path)
    ...
    def load_from_file(
        ...
        if file_extension in [".xlsx", ".xls"]:
            ...
            loader = TextLoader(file_path, encoding="utf-8") if not is_unstructured else UnstructuredFileLoader(file_path)
